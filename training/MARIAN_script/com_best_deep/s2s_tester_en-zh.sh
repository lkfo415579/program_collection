...
# model prefix
prefix=LSTM_ATTEN_model_en-zh_world/model_revo_s2s.npz.best-cross-entropy.npz
...
cat $dev | /home/revo/marian/build/s2s -c $prefix.yml -m $prefix -b 15 -n --mini-batch 1 --maxi-batch 1 2>/dev/null \
